...
namespace bha::build_systems {
    ...
    public:
         ...
         */
        [[nodiscard]] core::Result<std::vector<CompileCommand>> extract_compile_commands() override;
         ...
         */
        core::Result<std::map<std::string, std::vector<std::string>>> get_targets() override;

        /**
         * Retrieves the build order determined by CMake.
         * @return Ordered list of target names.
         */
        core::Result<std::vector<std::string>> get_build_order() override;
    ...
    private:
         ...
         */
        [[nodiscard]] core::Result<std::string> get_cmake_version() const;
         ...
         */
        [[nodiscard]] core::Result<std::string> read_cache_variable(const std::string& var_name) const;
