...
- Timestamp (UTC): `2026-03-12T09:02:34Z`
...
- Output dir: `/home/gregorian-rayne/CLionProjects/build-hotspot-analyzer/tests/cli/benchmarks/20260312-083345`
...
| `replay` | `weston` | `meson` | `clang` | `build_failed` | n/a | n/a | n/a | n/a | 0 | 0 | 0 |

## Failures

- `discover:meson/clang/weston`: `build_failed` (trace-bootstrap-failed-rc1)
- `replay:meson/clang/weston`: `build_failed` (trace-bootstrap-failed-rc1)
